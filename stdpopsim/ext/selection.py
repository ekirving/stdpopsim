...
class MutationType(object):
    ...
    # To add a new distribution type: add it here, validate the
    # distribution_args below, and add unit tests.
    _supported_distribution_types = ("f", "g")
    ...
    def __attrs_post_init__(self):
        ...
        # Explicitly validate distribution types/args that SLiM supports.
        if self.distribution_type not in self._supported_distribution_types:
            raise ValueError(
                    "The currently supported distribution types are: "
                    f"{self._supported_distribution_types}.")
...
def KimDFE():
    ...
    TODO: This really belongs in the HomSap catalog.
    """
